...
- After making code changes, run `bun check-all-for-ai` to execute all tests (takes up to 1 hour), or run `bun check-for-ai` for type checking and linting only (takes up to 10 minutes).
